...
import { Clock, LogOut, Sparkles, AlertTriangle, RefreshCw } from 'lucide-react';
      ...
      return (
        <div className="min-h-screen bg-navy-dark flex items-center justify-center p-6 text-center">
          <div className="premium-card p-10 max-w-md w-full bg-red-500/5 border-red-500/20">
            ...
            <h2 className="text-xl font-bold text-white mb-4 uppercase tracking-widest">System Collision</h2>
            <p className="text-red-400 text-sm leading-relaxed mb-8">
              A temporary malfunction occurred in the neural interface. The command center has been notified.
            </p>
            <button 
              onClick={() => window.location.reload()}
              className="w-full h-12 bg-red-500 text-white rounded-xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-red-600 transition-all"
            >
              <RefreshCw size={16} />
              Reboot Terminal
            </button>
